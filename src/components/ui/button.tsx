...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "md", type = "button", ...props }, ref) => {
    ...
    const variants: Record<NonNullable<ButtonProps["variant"]>, string> = {
      ...
      secondary: "border border-zinc-200 bg-white text-zinc-900 hover:border-zinc-300 hover:ring-1 hover:ring-zinc-200",
      outline: "border border-zinc-200 bg-white text-zinc-900 hover:border-zinc-300 hover:ring-1 hover:ring-zinc-200",
      ghost: "bg-transparent text-zinc-900 hover:bg-white hover:border hover:border-zinc-200",
